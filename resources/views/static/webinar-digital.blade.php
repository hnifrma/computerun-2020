    ...
    <body>
        <div class="container-2 content-top bg-event">
            ...
            <div class="margin-2 text-center content-divider">
                ...
                <p style="margin-top: .5rem;" class="h1 font-800 gradient-text">Digital Startup: "how to create your own masterpiece"</p>
            </div>
        </div>
            ...
            <div class="about-container margin-2 after-container-clip">
                ...
                <div>
                    <p class="h5" style="margin-top: 5rem;">
                        Webinar atau sesi seminar daring COMPUTERUN tahun ini mengangkat tema <i>Digital Startup: "how to create your own masterpiece"</i> untuk menambah pengetahuan dan berbagai pengalaman baru tentang <i>Technology in Business</i> kepada peserta.
                    </p>
                    <p class="h5">
