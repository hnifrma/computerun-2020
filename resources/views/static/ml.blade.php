...
<html>
    <head>
        @component("components.meta", ["title" => "Mini E-Sports: Mobile Legends"])
        @endcomponent
    </head>
    <body>
        <div class="container-2 content-top bg-event">
            ...
            @endcomponent
            @component("components.navbar-mobile", ['event' => ['register' => 'https://form.computerun.id/ml'], 'template' => 'event-details'])
            @endcomponent
            <div class="margin-2 text-center">
                <h3>ONLINE GAME TOURNAMENT</h3>
                <h1 class="gradient-text display-2 font-800">Mobile Legends: Bang Bang</h1>
                <a class="button button-gradient" href="https://form.computerun.id/ml">REGISTER</a>
                <a class="button button-white" href="#rules">RULES</a><br>
                <p class="text-center h5">
                    Registration Fee: <b class="teal-text">IDR 50K</b>/slot<br>
